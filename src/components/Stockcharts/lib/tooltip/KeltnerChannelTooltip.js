...
class KeltnerChannelTooltip extends Component {
	constructor(props) {
		super(props);
	...
	renderSVG(moreProps) {
		...
		const tooltipLabel = `KC(${sourcePath}, ${windowSize}, ${multiplier}, ${movingAverageType}): `;
...
KeltnerChannelTooltip.propTypes = {
...
KeltnerChannelTooltip.defaultProps = {
...
export default KeltnerChannelTooltip;